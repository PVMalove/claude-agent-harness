...
**Type:** type::implementation (or whichever `type::*` applies)
**Summary:** one-line description of what needs to happen

**Current behavior:**
Describe what happens now. For a fix, this is the broken behavior.
For a new capability, this is the status quo the feature builds on.
